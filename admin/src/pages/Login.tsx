        ...
        <div className="login-card px-8 py-10">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              ...
              {step === "password" && "Sign in with your credentials"}
            </p>
          </div>
            ...
            <form onSubmit={handlePasswordLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="h-10 bg-secondary/60 border-border/60 text-sm placeholder:text-muted-foreground/50"
                  required
                  autoFocus
                />
              </div>
              ...
              <button
                type="button"
                onClick={() => { setStep("phone"); setUsername(""); setPassword(""); }}
                className="flex items-center gap-1.5 text-xs text-muted-foreground/60 hover:text-muted-foreground mx-auto transition-colors"
              >
